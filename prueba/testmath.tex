...
\documentclass[draft,fleqn,leqno,11pt]{article}
\pagestyle{headings}
\usepackage{amsthm}
\usepackage{titlesec}
...
\newfontfamily{\serifpro}{Latin Modern Sans}
% \setsansfont[StylisticSet={1,3}]{Work Sans}
% \setmonofont{JetBrains Mono}
\setmathfont{Latin Modern Math}
\setmathfont[range={cal,frak}]{Neo Euler}
...
\textsf{Tengo una casita rosada y la quiero mucho} \\ 2$x^2$ a$x^{a^2}$
