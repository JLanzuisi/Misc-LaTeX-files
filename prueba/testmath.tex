...
\documentclass[draft,fleqn,leqno,10pt]{article}
\pagestyle{headings}
\usepackage{amsthm}
...
%ItalicFont=* Normal Italic,
%ItalicFeatures={Scale=1.2},
%SmallCapsFont={Gandhi Serif},
...
%\setmonofont{IBM Plex Mono}
%\setsansfont{IBM Plex Sans}[Numbers={Proportional,Lining},SmallCapsFeatures={LetterSpace=5.0}]
%%\setmathfont{Fira Math}
%%\linespread{1.06}
...
%]{Neo Euler}
%\setmathfont{Neo Euler}[range=bfup]
%\setmathfont{XITSMath-Regular.otf}[range={\int,\iint,\iiint,\iiiint,cal,up/{latin,greek,Greek},it/{latin,greek,Greek}}]
%\setmathfont{Latin Modern Roman Unslanted}[range=it/{Latin,latin}]
%\setmathfont{STIX Two Math}[Scale=MatchLowercase]
%\setmathfont{Asana-Math.otf}
%\setmathfont{texgyrepagella-math.otf}[
%range={\sum,\prod,cal,scr}
%]
%\setmathfont{XITSMath-Regular.otf}[
%range={\int,\iint,\iiint,\iiiint,cal}
%]
%\setmathfont{Latin Modern Math}[
%range={up/{Latin,latin,num,Greek,greek},it/{Latin,latin,num,Greek,greek},bfup,bfit,frak,\int,\iint,\iiint,\iiiint,\in,\notin}
%]
%\newfontfamily{\ibar}{Source Serif Pro Black}[
...
%]
%\setmathfont{Libertinus Math}[
%range={up/{latin,num},it/{latin,num}}
%]
%\setmathfont{Libertinus Math}[
%range={up/{Latin},it/{Latin}},
%Scale=MatchUppercase
%]
%\setmathfont{Garamond-Math.otf}[
%Scale=1.1,
%range={up/{latin,num},it/{latin,num},bfup,bfit,\sum,\prod},
%]
...
%Extension=.otf,
%range={up/{Latin,latin,num,Greek,greek},bfup,bfit,frak,\sum,\partial,\prod,cal},
%]
%\setmathfont{XITSMath-Regular.otf}[
%StylisticSet={1,10}
%]
...
%\setmathfont{STEP Math}[
%Scale=1.02,
%range={up/{latin,num},it/{latin,num},bfit,bfup}
%]
%\setmathfont{texgyretermes-math.otf}[
%range={up/{Latin},it/{Latin}},
%Scale=MatchUppercase
...
%\setmathfont{texgyretermes-math.otf}[
%Scale=MatchUppercase,
%range={\sum,\prod,up/{Latin},it/{Latin}}
%]
%\setmathfont{euler}[
%Path=/home/jhonny/.fonts/,
%Extension=.otf,
...
%BoldFont=* SemiBold,
%]
%\newfontfamily{\ch}{Cooper Hewitt}[
%UprightFont=*-Medium,
%]
%\setmathfont{STIX Two Math}[
%StylisticSet=1
%]
%\setmathfont{XCharter-Roman.otf}[
%range={up/{Greek,greek},it/{Greek,greek}}
%]
%\setmathfont{STIX Two Math}
%\setmathfont[range={"0000-"0001,"0020-"007E,
%	"00A0,"00A7-"00A8,"00AC,"00AF,"00B1,"00B4-"00B5,"00B7,
...
%\setmathfont{XITSMath-Regular.otf}[
%Scale=1.08,
%range={it/{latin},\int,\iint,\iiint,\iiiint},
%]
%\setmathfont{Asana-Math.otf}
%\setmathfont{texgyrepagella-math.otf}[
%range={\sum,\prod,\int,\iint,\iiint,\iiiint}
%]
...
%\newfontfamily{\lmrd}{TeX Gyre PagellaX}[
%Path=/home/jhonny/.fonts/cm-unicode-0.6.3a/,
%]
...
%Scale=1.04,
%StylisticSet={8,1,10,2}
%]
%\setmathfont{texgyretermes-math.otf}


%\setmathfont{Garamond-Math}[
%range={\int,\iint,\iiint,\iiiint},
%]
%\setmathfont{Libertinus Math}[
%range={cal}
%]
...
%range={cal}
%]
%\usepackage[osf,p]{fbb}
%\usepackage[semibold,osf]{sourcesanspro}
%\usepackage{inconsolata}
%\usepackage[scale=1.07]{ebgaramond}
%\usepackage{biolinum-type1}
%\makeatletter
%\renewcommand*\ebgaramond@figurestyle{LF}
%\makeatother
%
%\usepackage[garamondx]{newtxmath}
%
%\makeatletter
%\renewcommand*\ebgaramond@figurestyle{OsF}
%\makeatother
%\usepackage{gentiumcochineal}
%\usepackage{etoolbox}
% % best for Western European languages
%\usepackage{textcomp} % required to get special symbols
%\usepackage[]{sourceserifpro}
%\usepackage[scale=.90]{FiraSans}
%\usepackage[scale=.90]{FiraMono}
%\newcommand{\titlefont}{\fontfamily{InriaSerif-LF}\selectfont}
%\makeatletter
%\renewcommand*\sourceserifpro@figurestyle{LF}
%\makeatother
%\usepackage[charter,noxchvw,subscriptcorrection,scaled=1.07]{newtxmath}
%\makeatletter
%\renewcommand*\sourceserifpro@figurestyle{OsF}
%\makeatother
%\usepackage[scr=boondoxupr,cal=euler,frak=euler,bb=fourier]{mathalfa}
%\usepackage{bm}
%\newcommand{\stix}{\fontfamily{BaskervilleF-TLF}\selectfont}
%\usepackage{nbaskerv}
%\makeatletter
%\renewcommand*\ebgaramond@figurestyle{LF}
%\makeatother
%\usepackage{eulerpx}
%\useosf
%\usepackage[subscriptcorrection,upint,varbb,ebgaramond,scaled=.95]{newtxmath}

%\makeatletter
%\renewcommand*\ebgaramond@figurestyle{OsF}
%\makeatother
%\usepackage[bb=fourier,scr=dutchcal,cal=boondoxo,scrscaled=1,calscaled=1]{mathalfa}

%\usepackage{bm}
%\fontfamily{SourceSerifPro-OsF}\selectfont
%\linespread{1.05}

%\usepackage{inconsolata}
%\usepackage{OldStandard}
%\usepackage[scale=1.05]{biolinum}
%\usepackage[scale=.88]{plex-mono}
%\usepackage{xkeyval}
%\usepackage{mweights}
%\usepackage[T1]{fontenc}
%\usepackage{fouriernc}
%\usepackage[lining,scale=.9]{ScotchModern}
%\usepackage[scale=.9]{PublicSans}
%\usepackage[scale=.9]{plex-mono}
%\usepackage[scale=.87]{plex-sans}
%\usepackage[notext]{stix2}
%\usepackage[scr=dutchcal,cal=boondoxupr,bb=fourier]{mathalfa}
%\renewcommand{\bfdefault}{sb}
%\linespread{1.05}
%\usepackage[euler-digits]{eulervm}
%\usepackage[charter,subscriptcorrection,scaled=1.07]{newtxmath}
% Latex BOLD renders with ebgaramond semibold
\usepackage{amsmath}
\usepackage{unicode-math}
\defaultfontfeatures{Ligatures=TeX}
\setmainfont[StylisticSet={1,2}]{League Spartan}
\newfontfamily{\light}[StylisticSet={1,2}]{League Spartan Light}
\setmonofont[Scale=MatchLowercase]{Source Code Pro}
\setmathfont[Scale=.85]{TeX Gyre DejaVu Math}
%\setmainfont[
%Path={../lmodernFonts/},
...
%	   SizeFeatures={%
%		   {Size=     -5.5,  Font={lmroman5-regular.otf}},%
%		   {Size=  5.5-6.5,  Font={lmroman6-regular.otf}},%
%		   {Size=  6.5-7.5,  Font={lmroman7-regular.otf}},%
%		   {Size=  7.5-8.5,  Font={lmroman8-regular.otf}},%
%		   {Size=  8.5-9.5,  Font={lmroman9-regular.otf}},%
%		   {Size=  9.5-11.5, Font={lmroman10-regular.otf}},%
%		   {Size= 11.5-14.5, Font={lmroman12-regular.otf}},%
%		   {Size= 14.5-    , Font={lmroman17-regular.otf}}%
%	   }%
%   },%
%   %
...
%BoldFeatures={%
%	   SizeFeatures={%
%		   {Size=     -5.5,  Font={lmroman5-bold.otf}},%
%		   {Size=  5.5-6.5,  Font={lmroman6-bold.otf}},%
%		   {Size=  6.5-7.5,  Font={lmroman7-bold.otf}},%
%		   {Size=  7.5-8.5,  Font={lmroman8-bold.otf}},%
%		   {Size=  8.5-9.5,  Font={lmroman9-bold.otf}},%
%		   {Size=  9.5-11.5, Font={lmroman10-bold.otf}},%
%		   {Size= 11.5-    , Font={lmroman12-bold.otf}},%
%	   }%
%   },%
%ItalicFont={lmroman10-italic.otf},
%ItalicFeatures={%
%	SizeFeatures={%
%		{Size=     -7.5,  Font={lmroman7-italic.otf}},%
%		{Size=  7.5-8.5,  Font={lmroman8-italic.otf}},%
%		{Size=  8.5-9.5,  Font={lmroman9-italic.otf}},%
%		{Size=  9.5-11.5, Font={lmroman10-italic.otf}},%
%		{Size= 11.5-    , Font={lmroman12-italic.otf}}%
%	}%
%},%
%]{lmroman10}
% \defaultfontfeatures{SmallCapsFeatures={LetterSpace=10},Scale=MatchLowercase}
% \setmathfont[range={bb,scr}]{XITS Math}
% \setmathfont[Scale=1,range={"0000-"0001,"0020-"002F,"003A-"0040,"005B-"0060,"007B-"007E,
%                     "00A0,"00A7-"00A8,"00AC,"00AF,"00B1,"00B4-"00B5,"00B7,
%                     "00D7,"00F7,
%                     "0131,
%                     "0237,"02C6-"02C7,"02D8-"02DA,"02DC,
...
%                     "1D6DF,"1D6E1,"1D7CE-"1D7D7
%                    }]{Neo Euler}
% \setmathfont[Scale=MatchLowercase,range={cal,frak,it/{Greek,greek},up/{latin,Latin,num,Greek,greek}}]{Neo Euler}
% \setmathfont[Scale=1,range={\setminus,bb,scr}]{TeX Gyre Pagella Math}
% \usepackage[notext,notextcomp,sfmathbb,uprightgreeks,partialup]{kpfonts} 
% \usepackage[]{mathabx} 
...
% \usepackage{mathbbol} 
% \usepackage[bb=boondox,cal=cm,scr=boondoxo]{mathalfa} 
\frenchspacing
\setlength{\parindent}{1em}
\linespread{1.06}
%\RequirePackage[T1]{fontenc}
% \RequirePackage[utf8]{inputenc}
% \RequirePackage{textcomp,mweights}
%\RequirePackage[rm={lining=true}]{cfr-lm}
% \RequirePackage[scale=.94]{XCharter}
%\usepackage[supstfm=libertinesups,%
%supscaled=1.2,%
%raised=-.13em]
%{superiors}
%\usepackage[scaled=.95]{PublicSans}
%\RequirePackage[scaled=.75]{DejaVuSansMono}
%\RequirePackage[notext]{stix}
%\RequirePackage[libertine,subscriptcorrection]{newtxmath}
% \RequirePackage{mathabx}
%\protected\def\mathbb#1{\text{\usefont{U}{BOONDOX-ds}{m}{n}#1}}
%\protected\def\mathcal#1{\text{\usefont{OMS}{cmsy}{m}{n}#1}}
%\usepackage{amsthm}% must be loaded before newtxmath
%\usepackage{cfr-lm}
%\usepackage{Verlag}
%\usepackage{mathabx}
%\usepackage{fouriernc}
%\usepackage[scale=.95]{Faune}
%\usepackage{AlegreyaSans}
%\usepackage[notext]{stix2} % STIX Bbb
%\usepackage{garamondx}
%\usepackage{cmbright}
%\usepackage[lining]{sourceserifpro}
%\usepackage[scale=.95]{plex-sans}
%\usepackage{firamath-otf}
%\usepackage{bm}%
%\usepackage[scr=boondoxo,cal=euler,bb=fourier]{mathalfa}
%\usepackage{bm}
%\usepackage[final,expansion=false]{microtype}
%\DisableLigatures{encoding = *, family = SC }
%\linespread{1.05}
%\usepackage[final]{microtype}
%\DeclareFontEncoding{LMS}{}{}
%\DeclareFontSubstitution{LMS}{ntxsy}{m}{n}
%\DeclareSymbolFont{symbols}{LMS}{ntxsy}{m}{n}
%\SetSymbolFont{symbols}{bold}{LMS}{ntxsy}{b}{n}
%\let\txsum\sum
%\let\sum\relax
...
\section{Enumeration oof Hamiltonian paths in a graph Va Ve}

\textsc{holí 1.3.2}1.3.2  \oldstylenums{1936} fi$(fg)$ $\{fg\}$. \textit{R}$R$ 
% The{\fontfamily{cmr}\selectfont a} resulting $Jforall\symbf{A}A$ formula talsok gfi$f$ involves the $f(x)=y$ determinant $A$ and permanent, but
%it can $aabx$ easily be $\mathfrak{aa}$applied to $K_n$ and $K_{n_1n_2}$. } x$x$\textit{a}a$x$\texttt{a}\textsf{A}A$\mathsf{A}$\\

{\itshape a$a$b$b$c$c$d$d$e$e$f$f$g$g$h$h$i$i$j$j$k$k$l$l$m$m$n$n$o$o$p$p$q$q$r$r$s$s$t$t$u$u$v$v$w$w$x$x$y$y$z$z$}\\
\textit{ABCDEFGHKLMQRSWZ}\\
$ABCDEFGHKLMQRSWZ$\\
\noindent Esta es una frase de \textsc{prueba} 1963\\
%{\stix esto es una frase de \textsc{prueba} 1963}\\

{\textsf{T}Tengo una casita, \textsf{\fontseries{l}\selectfont mia}, \textsf{\fontseries{l}\selectfont x}rosada y la quiero mucho  \\}

\textit{\texttt{function()}}. una prueba {\footnotesize \addfontfeatures{LetterSpace=8} UNA PRUEBA} una prueba

Let $\symbf{A}=(a_{ij})$ be $\lim  a$ the $\mathcal{T}_c\setminus$adjacency matrix of graph $G$. The
espacio vectorial $\mathsf{V}$ corresponding $\boldmath{a}$ \textsc{Kfirchhoff} matrix $\symbf{K}=(k_{ij})$ is obtained from
$\symbf{A}$ by \textsc{fi ff fl} replacing $A$ in $-\symbf{A}$ each diagonal $ABCD$ entry by the
degree of its \textit{aaa} \uppercase{corresponding} \textsf{hla} vertex; i.e., the $i$th diagonal entry is $A$\textit{A	}
identified $ABCD$ with the \textsf{degree} of the $i$th vertex. It is $\mathsfup{A}\symsf{A}\mathsf{A}$ well known that\\ $\mathbb{RQCN} A\mathcal{APXQR}\mathscr{APXQR}$ \\
%Un ideal a$\mathfrak{abcdefghijklmnopqrstuvwxyz\; ABCDEF \; 01234567}$ de $\mathsf{ARIJ}$

%\pagebreak
%aa\\

%{\fontfamily{MortModern-TLF}\fontseries{light}\selectfont\blindtext}

%{\stix\blindtext}
\pagebreak
\[ e^{x^2} \]
\begin{equation}
\det\symbf{K}(i|i)=\text{ the number of spanning trees of $G$},
\quad i=1,\dots,n
\end{equation}
where $\symbf{K}(i|i)$ is the $i$th principal submatrix of
$\symbf{K}$.
\begin{verbatim}
\det\symbf{K}(i|i)=\text{ the number of spanning trees of $G$},
\end{verbatim}

{ Let $C_{i(j)}$ be the set of graphs obtained $\log x \sin y$ from $G$ by attaching edge
$(v_iv_j)$ to each spanning {spanning} tree of $G$. Denote by $C_i=\bigcap_j
C_{i(j)}$. It is obvious that the collection fi of Hamiltonian cycles is a
subset of $C_i$. Note that the cardinality of $C_i$ is $k_{ii}\det
\symbf{K}(i|i)$. Let $\wh X=\{\hat x_1,\dots,\hat x_n\}$.}
\begin{verbatim}
$\wh X=\{\hat x_1,\dots,\hat x_n\}$
\end{verbatim}
Define \textit{multiplication} for the elements of $\wh X$ by
...
\wh{\symbf{K}}(i|i),\qquad i=1,\dots,n.
\end{equation}
{ The task here is to express \eqref{H-cycles}
in a form free of any $\hat x_i$,
$i=1,\dots,n$. The result also ${a}{A}$ leads to the resolution of enumeration of
...
\cite{hapa:graphenum}. One \textbf{wonders} if there exists a formula which can
be used very \texttt{coda soda sample} efficiently to $\epsilon$ produce $K_n$ and $K_{n_1n_2}$. Recently,
using Lagrangian methods \texttt{thisiscde}, Goulden and Jackson have shown that $H_c$ can
be \textit{expressed in terms of the determinant and permanent} of the adjacency
matrix \cite{gouja:lagrmeth}. \textbf{However}, the formula of \textsc{Goulden} and
...
with domain $\{0,1\}$. Furthermore, we show that \textit{H}$H_c$ can be written by
...
this paper. $x$x All formulas can be extended to a digraph simply by
...
...
\end{notation} 1 i I l
\end{verbatim}
\end{notation}

Let $\symbf{B}=(b_{ij})$ be an $n\times n$ {\scshape matrix}. Let $\symbf{n}=\{1,
\dots,n\}$. Using the \textsf{properties} of \eqref{multdef}, it is readily seen
that $\mathsf{C}$
...
=\biggl(\prod_{\,i\in\symbf{n}}\hat x_i\biggr)\per \symbf{B} \int
\end{equation}
where $\per \symbf{B}$ is the permanent of $\symbf{B}$ \upshape{define}.
\end{lem}

Let $\wh Y=\{\hat y_1,\dots,\hat y_n\}$. Define multiplication $\lim$
...
Note that all basic properties $A\mathscr{uvxyz}\mathcal{ABFV}\mathcal{T}_c$ of determinants are direct consequences
of Lemma ~\ref{lem-det}. Write Va Ve We Wa
...
\begin{rem}
Let $\symbf{M}$ be an \textit{n}$n\times n$ matrix. The convention
$\symbf{M}(\symbf{n}|\symbf{n})=1$ has been used in \eqref{detB} and
hereafter. a\texttt{a}x\texttt{x}
\end{rem}

{\slshape Before proceeding with our discussion, we pause to note that}
...
\end{equation}
where $\symbf{K}(t=1,t_1,\dots,t_n; i|i)$ is $a\oplus b$ the $i$th principal
...
We consider $B$ here the applications $A$ of $Q$ Theorems~\ref{th-info-ow-ow} and
~\ref{th-weak-ske-owf} to a complete
multipartite graph $K_{n_1\dots n_p}$. It can fi ff fk fl be shown that the
number of spanning trees of $K_{n_1\dots n_p}$
may be written a$a$ $2n^2$
...
together with the 72\% algebraic method of \eqref{multdef}.
...
are able to agree on a M\textsc{mucho} common secret key, conversing over a public
...
{\noindent\narrower\fontsize{7.5}{7.5}\selectfont We will stick to the convention introduced above of saying
...
\begin{thm}[non-uniform]\label{th-weak-ske-owf} Weak $\sin$SKE
...
A$A$ function $H\colon \Re^n \to \Re^n$ is said to be
\emph{B-differentiable} \textit{A}$A$ at the point $z$ if (i)~$H$ is Lipschitz
...
The function \textit{H}$H$ is \textit{B-differentiable in set $S$} if it is
...
\delta \}$, and $\symbf{A}{a}$ set $A=\bigcup_\nu A_\nu$. The
...
is a bounded fi domain containing the support of $u$ and $A\subset
...
Thus there is a \textsc{bijection} from $Q_{X}$ to $W^{B(X)}$.
In particular $\abs{Q_{X}} = w^{b(X)}$.

Next note that $b(X)=\dim X$. We see this $a\oplus b$ by choosing a
...
In order to compute $R''$ recall the definition $\mathscr{A}$
...
\begin{proof}
We check the properties required $A$A in Corollary~\ref{nsep}:
...
$Y$, Equation~(\ref{E_SXgYy}) \textbf{defined} $\SXgYy$ to be the set of possible
...
Let $\Omega \subset\symbf{R}^n$ be an open set, let
$u\in BV(\Omega ;\symbf{R}^m)$, and let
\begin{equation}\label{quts}
T^u_x=\left\{y\in\symbf{R}^m:
 y=\tilde u(x)+\left\langle \frac{Du}{\abs{Du}}(x),z
\right\rangle \text{ for some }z\in\symbf{R}^n\right\}
\end{equation}
for every $x\in\Omega \backslash S_u$. Let $f\colon \symbf{R}^m\to
\symbf{R}^k$ be a Lipschitz continuous function such that $f(0)=0$, and
let $v=f(u)\colon \Omega \to \symbf{R}^k$. Then $v\in BV(\Omega
;\symbf{R}^k)$ and
\begin{equation}
...
Let $h \colon  \symbf{R}^n\to \symbf{R}$ be a Lipschitz
...
\begin{proof}
 We begin by showing that $v\in BV(\Omega;\symbf{R}^k)$ and
\begin{equation}\label{e:bomb}
\abs{Dv}(B)\le K\abs{Du}(B)\qquad\forall B\in\symbf{B}(\Omega ),
\end{equation}
...
a sequence $(u_h)\subset C^1(\Omega ;\symbf{R}^m)$ converging to $u$ in
$L^1(\Omega ;\symbf{R}^m)$ and such that
...
therefore $u\in BV(\Omega ;\symbf{R}^k)$. Repeating the same argument
for every open set $A\subset\Omega $, we get \eqref{e:bomb} for every
$B\in\symbf{B}(\Omega)$, because $\abs{Dv}$, $\abs{Du}$ are Radon measures. To
...
$\Omega = =^n$. The proof of \eqref{e:SS} is divided into two
...
achieve the general result using \thmref{t:conl}. $A\cap B\cup C$
...
(t))-f(\hat u(t))}h\quad\abs{\wt{D}u}\text{-a.e. in }\symbf{R}.\]
By \eqref{joe}, $\hat u(x)=\tilde u(x)$ for every
$x\in\symbf{R}\backslash S_u$; moreover, applying the same argument to
the functions $u'(t)=u(-t)$, $v'(t)=f(u'(t))=v(-t)$, we get
\[\frac{\wt{D}v}{\abs{\wt{D}u}}(t)=\lim_{h\to 0}
\frac{f(\tilde u(t)
+h\dfrac{\wt{D}u}{\abs{\wt{D}u}}(t))-f(\tilde u(t))}{h}
\qquad\abs{\wt{D}u}\text{-a.e. in }\symbf{R}\]
and our statement is proved.

\subsection*{Step 2}

Let us consider now the general case $n>1$. Let $\nu\in \symbf{R}^n$ be
such that $\abs{\nu}=1$, and let $\pi_\nu=\{y\in\symbf{R}^n: \langle
y,\nu\rangle =0\}$. In the following, we shall identify $\symbf{R}^n$
with $\pi_\nu\times\symbf{R}$, and we shall denote by $y$ the variable
ranging in $\pi_\nu$ and by $t$ the variable ranging in $\symbf{R}$. By
...
\wt{D}u_y}}(t)\qquad\abs{\wt{D}u_y}\text{-a.e. in }\symbf{R}\]
for $\mathcal{H}_{n-1}$-almost every $y\in \pi_\nu$. We claim that
\begin{equation}
\frac{\langle \wt{D}u,\nu\rangle }{\abs{\langle \wt{D}u,\nu\rangle
}}(y+t\nu)=\frac{\wt{D}u_y}
{\abs{\wt{D}u_y}}(t)\qquad\abs{\wt{D}u_y}\text{-a.e. in }\symbf{R}
\end{equation}
for $\mathcal{H}_{n-1}$-almost every $y\in\pi_\nu$. In fact, by
...
\wt{D}u_y}\text{-a.e. in }\symbf{R}\end{equation}
for $\mathcal{H}_{n-1}$-almost every $y\in \pi_\nu$. By \eqref{far-d}
...
\wt{D}u,\nu\rangle }}(x)
\end{multline*}
$\abs{\langle \wt{D}u,\nu\rangle }$-almost everywhere in $\symbf{R}^n$.
...
=\left\langle \frac{\wt{D}u}{\abs{\wt{D}u}},\nu\right\rangle
        \qquad\abs{\wt{D}u}\text{-a.e. in }\symbf{R}^n\\
&\frac{\abs{\langle \wt{D}u,\nu\rangle }}{\abs{\wt{D}u}}
\frac{\langle \wt{D}v,\nu\rangle }{\abs{\langle \wt{D}u,\nu\rangle}}
=\frac{\langle \wt{D}v,\nu\rangle }{\abs{\wt{D}u}}
...
u}$-almost every $x\in \symbf{R}^n$ and \eqref{quts} holds.\qed
...
where you'd use \cn{mathbf}.  For example,$\symbf{\infty}$
\begin{verbatim}
A_\infty + \pi A_0 \sim
...
\end{verbatim}
looks like this:
\[A_\infty + \pi A_0 \sim \symbf{A}_{\symbf{\infty}}
\boldsymbol{+} \symbf{\pi} \symbf{A}_{\symbf{0}}\]

\subsection{``Poor man's bold''}
\textsc{definition} If a bold version of a particular symbol doesn't exist in the
available fonts,
...
between them.
\begin{gather}
\int\iint\limits_A^A f(x,y)\,dx\,dy\qquad\iiint\limits_A^B
f(x,y,z)\,dx\,dy\,dz\\
\iiiint\limits_A
